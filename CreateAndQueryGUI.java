...
public class CreateAndQueryGUI extends JFrame {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jLabelQuery.setBounds(new Rectangle(63, 210, 75, 20));
		jTextFieldQuery.setBounds(new Rectangle(138, 211, 391, 18));
		jLabelMinBet.setBounds(new Rectangle(63, 240, 75, 20));
...
//					public void propertyChange(PropertyChangeEvent propertychangeevent) {
		...
		jLabelEventDescription.setBounds(25, 320, 91, 20);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (pr.length() > 0) {
							...
							boolean a=facade.createPronostic(pr,ev,i);
						

							jLabelMsg2.setText(ResourceBundle.getBundle("Etiquetas").getString("PronosticCreated"));
